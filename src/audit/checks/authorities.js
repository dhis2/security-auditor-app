...
import { summarizeAuthorityHolders } from '../helpers'
...
export const getAuthorityChecks = (config) => [
    {
        ...
        evaluate: (_data, ctx) =>
            summarizeAuthorityHolders({
                ...
                authority: 'ALL',
                authorityLabel: 'ALL',
                contextLabel: i18n.t('super user access'),
    ...
    },
    {
        ...
        evaluate: (_data, ctx) =>
            summarizeAuthorityHolders({
                ...
                contextLabel: i18n.t('public route creation access'),
                maxAllowed: config.maxSuperUserRoles || 5,
            }),
    },
    {
        ...
        evaluate: (_data, ctx) =>
            summarizeAuthorityHolders({
                ...
                contextLabel: i18n.t('impersonation access'),
                maxAllowed: config.maxSuperUserRoles || 5,
            }),
    },
    {
        ...
        evaluate: (_data, ctx) =>
            summarizeAuthorityHolders({
                ...
                contextLabel: i18n.t('system settings access'),
                maxAllowed: config.maxSuperUserRoles || 5,
            }),
    },
]
